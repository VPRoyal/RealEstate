        ...
        return (
            <div className={styles["facilities"]}>
                            ...
                            <p>
                                ...
                                <span>Kaushik Public school (0.7 kms), NK Public School (2 kms)</span><span></span>
                            </p>
                            <p><span id={styles["facility-icon"]}>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        className="bi bi-file-earmark-medical" viewBox="0 0 16 16">
                                        <path
                                ...
                                <span>Khetan Gov. Hospital (5 kms)</span><span></span>
                            </p>
                            <p><span id={styles["facility-icon"]}>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <span>Bus Stand (1 kms)</span><span></span>
                            </p>
                            <p><span id={styles["facility-icon"]}>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <span>Grocery Market (1.5 kms)</span><span></span>
                            </p>
                        </div>
        )
    }
